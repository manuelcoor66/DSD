...
class Client(Iface):
    ...
    def elevar(self, num1, num2):
        ...
        """
        self.send_elevar(num1, num2)
        return self.recv_elevar()

    def send_elevar(self, num1, num2):
        self._oprot.writeMessageBegin('elevar', TMessageType.CALL, self._seqid)
        args = elevar_args()
        args.num1 = num1
        args.num2 = num2
        args.write(self._oprot)
    ...
    def recv_elevar(self):
        ...
        if mtype == TMessageType.EXCEPTION:
            ...
            iprot.readMessageEnd()
            raise x
        result = elevar_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "elevar failed: unknown result")
    ...
    def valor_absoluto(self, num1):
        ...
        """
        self.send_valor_absoluto(num1)
        return self.recv_valor_absoluto()

    def send_valor_absoluto(self, num1):
        self._oprot.writeMessageBegin('valor_absoluto', TMessageType.CALL, self._seqid)
        args = valor_absoluto_args()
        args.num1 = num1
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_valor_absoluto(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = valor_absoluto_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "valor_absoluto failed: unknown result")
...
class Processor(Iface, TProcessor):
    ...
    def process_elevar(self, seqid, iprot, oprot):
        args = elevar_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = elevar_result()
        try:
            result.success = self._handler.elevar(args.num1, args.num2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("elevar", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_valor_absoluto(self, seqid, iprot, oprot):
        args = valor_absoluto_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = valor_absoluto_result()
        try:
            result.success = self._handler.valor_absoluto(args.num1)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("valor_absoluto", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class elevar_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('elevar_args')
        if self.num1 is not None:
            oprot.writeFieldBegin('num1', TType.I32, 1)
            oprot.writeI32(self.num1)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(elevar_args)
elevar_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'num1', None, None, ),  # 1
    (2, TType.I32, 'num2', None, None, ),  # 2
)
...
class elevar_result(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('elevar_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I32, 0)
            oprot.writeI32(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(elevar_result)
elevar_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
)
...
class valor_absoluto_args(object):
    """
    Attributes:
     - num1
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('valor_absoluto_args')
        if self.num1 is not None:
            oprot.writeFieldBegin('num1', TType.I32, 1)
            oprot.writeI32(self.num1)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(valor_absoluto_args)
valor_absoluto_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'num1', None, None, ),  # 1
)


class valor_absoluto_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('valor_absoluto_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.I32, 0)
            oprot.writeI32(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(valor_absoluto_result)
valor_absoluto_result.thrift_spec = (
    (0, TType.I32, 'success', None, None, ),  # 0
)
