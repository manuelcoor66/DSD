...
{
	return (sumar_1_svc(argp->n1, argp->n2, rqstp));
}

static double *
_multiplicar_1 (multiplicar_1_argument *argp, struct svc_req *rqstp)
{
	return (multiplicar_1_svc(argp->n1, argp->n2, rqstp));
}

static double *
_restar_1 (restar_1_argument *argp, struct svc_req *rqstp)
{
	return (restar_1_svc(argp->n1, argp->n2, rqstp));
}

static double *
_dividir_1 (dividir_1_argument *argp, struct svc_req *rqstp)
{
	return (dividir_1_svc(argp->n1, argp->n2, rqstp));
}

static double *
_modulo_1 (modulo_1_argument *argp, struct svc_req *rqstp)
{
	return (modulo_1_svc(argp->n1, argp->n2, rqstp));
}

static double *
_elevar_1 (elevar_1_argument *argp, struct svc_req *rqstp)
{
	return (elevar_1_svc(argp->n1, argp->n2, rqstp));
}

static double *
_raiz_cuadrada_1 (int  *argp, struct svc_req *rqstp)
{
	return (raiz_cuadrada_1_svc(*argp, rqstp));
}

static double *
_valor_absoluto_1 (int  *argp, struct svc_req *rqstp)
{
...
calculadora_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case ELEVAR:
		_xdr_argument = (xdrproc_t) xdr_elevar_1_argument;
		_xdr_result = (xdrproc_t) xdr_double;
